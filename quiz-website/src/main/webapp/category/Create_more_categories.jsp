...
<nav class="navbar navbar-expand-lg navbar-light custom-navbar">
    <div class="container-fluid">
        <a class="navbar-brand" href="/home/teacher_home.jsp">
            <strong>
...
<div style="justify-content:center; width: 600px; margin: auto; margin-top: 265px ">
    ...
    <form action="/category?action=category" method="post">
        ...
        <div class="mb-3">
            <label style="color: #020053 ; text-align: left">Description</label>
            <input type="text" id="describe" name="describe" class="form-control" required>
        </div>

        <div class="d-grid gap-2">
            <input type="submit" value="Create" style=" background-color: #38368b;color: #FBEAEB"
                   class="btn btn-primary">
            <input type="reset" value="Reset" style=" background-color: #38368b;color: #FBEAEB"
